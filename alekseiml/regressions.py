...
class RandomNormalEstimator(Regression, BaseModel):
    def __init__(self):
        self._mean = 0
        self._std = 1
...
class RandomUniformEstimator(Regression, BaseModel):
    def __init__(self):
        self._tmin = 0
        self._tmax = 1
...
class LinearRegressionLMS(BaseModel, Regression):
...
class LinearRegressorGD(BaseModel, Regression):
    def __init__(self) -> None:
        self.w = None
